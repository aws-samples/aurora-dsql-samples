...
from repopulate import repopulate_test_data
...
def main():
    ...
    try:
        ...
        # 3. Sequential batch UPDATE — update 'clothing' status to 'processed'
        run_operation(
        ...
        # 5. Parallel batch DELETE — delete all 'food' rows
        run_operation(
        ...
        # 7. Parallel batch UPDATE — update 'books' status to 'archived'
        run_operation(
