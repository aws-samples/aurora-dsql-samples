...
CREATE TABLE "specialty_to_vet" (
	...
	CONSTRAINT "specialty_to_vet_specialty_name_specialty_name_fk" FOREIGN KEY ("specialty_name")
		REFERENCES "specialty"("name") ON DELETE RESTRICT ON UPDATE RESTRICT,
	CONSTRAINT "specialty_to_vet_vet_id_vet_id_fk" FOREIGN KEY ("vet_id")
