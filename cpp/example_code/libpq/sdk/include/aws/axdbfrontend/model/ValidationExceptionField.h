...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/axdbfrontend-2018-05-10/ValidationExceptionField">AWS
   * API Reference</a></p>
   */
  class ValidationExceptionField
  {
  public:
    AWS_AXDBFRONTEND_API ValidationExceptionField();
    AWS_AXDBFRONTEND_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
    AWS_AXDBFRONTEND_API ValidationExceptionField& operator=(Aws::Utils::Json::JsonView jsonValue);
