...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/axdbfrontend-2018-05-10/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
  class ServiceQuotaExceededException
  {
  public:
    AWS_AXDBFRONTEND_API ServiceQuotaExceededException();
    AWS_AXDBFRONTEND_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
    AWS_AXDBFRONTEND_API ServiceQuotaExceededException& operator=(Aws::Utils::Json::JsonView jsonValue);
