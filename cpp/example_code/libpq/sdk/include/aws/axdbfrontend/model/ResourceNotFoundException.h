...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/axdbfrontend-2018-05-10/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_AXDBFRONTEND_API ResourceNotFoundException();
    AWS_AXDBFRONTEND_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_AXDBFRONTEND_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
