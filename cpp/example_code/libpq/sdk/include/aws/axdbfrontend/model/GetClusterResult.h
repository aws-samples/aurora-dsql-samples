...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/axdbfrontend-2018-05-10/GetClusterOutput">AWS
   * API Reference</a></p>
   */
  class GetClusterResult
  {
  public:
    AWS_AXDBFRONTEND_API GetClusterResult();
    AWS_AXDBFRONTEND_API GetClusterResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_AXDBFRONTEND_API GetClusterResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
