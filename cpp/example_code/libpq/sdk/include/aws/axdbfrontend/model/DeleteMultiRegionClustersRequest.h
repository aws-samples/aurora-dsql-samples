...
namespace Model
{
  ...
  /**
   */
  class DeleteMultiRegionClustersRequest : public AxdbFrontendRequest
  {
  public:
    AWS_AXDBFRONTEND_API DeleteMultiRegionClustersRequest();
    ...
    AWS_AXDBFRONTEND_API void AddQueryStringParameters(Aws::Http::URI& uri) const override;
