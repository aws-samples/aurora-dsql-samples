...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/axdbfrontend-2018-05-10/ThrottlingException">AWS
   * API Reference</a></p>
   */
  class ThrottlingException
  {
  public:
    AWS_AXDBFRONTEND_API ThrottlingException();
    AWS_AXDBFRONTEND_API ThrottlingException(Aws::Utils::Json::JsonView jsonValue);
    AWS_AXDBFRONTEND_API ThrottlingException& operator=(Aws::Utils::Json::JsonView jsonValue);
