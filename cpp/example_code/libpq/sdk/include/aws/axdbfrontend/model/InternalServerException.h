...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/axdbfrontend-2018-05-10/InternalServerException">AWS
   * API Reference</a></p>
   */
  class InternalServerException
  {
  public:
    AWS_AXDBFRONTEND_API InternalServerException();
    AWS_AXDBFRONTEND_API InternalServerException(Aws::Utils::Json::JsonView jsonValue);
    AWS_AXDBFRONTEND_API InternalServerException& operator=(Aws::Utils::Json::JsonView jsonValue);
