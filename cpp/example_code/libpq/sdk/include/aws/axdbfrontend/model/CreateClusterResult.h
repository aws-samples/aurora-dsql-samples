...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/axdbfrontend-2018-05-10/CreateClusterOutput">AWS
   * API Reference</a></p>
   */
  class CreateClusterResult
  {
  public:
    AWS_AXDBFRONTEND_API CreateClusterResult();
    AWS_AXDBFRONTEND_API CreateClusterResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_AXDBFRONTEND_API CreateClusterResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
