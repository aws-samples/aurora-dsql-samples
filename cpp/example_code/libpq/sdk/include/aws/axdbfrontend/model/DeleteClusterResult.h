...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/axdbfrontend-2018-05-10/DeleteClusterOutput">AWS
   * API Reference</a></p>
   */
  class DeleteClusterResult
  {
  public:
    AWS_AXDBFRONTEND_API DeleteClusterResult();
    AWS_AXDBFRONTEND_API DeleteClusterResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_AXDBFRONTEND_API DeleteClusterResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
