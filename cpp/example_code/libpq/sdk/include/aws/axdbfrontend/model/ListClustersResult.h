...
#include <aws/axdbfrontend/model/ClusterSummary.h>
#include <utility>
...
namespace Model
{
  ...
  {
  public:
    AWS_AXDBFRONTEND_API ListClustersResult();
    AWS_AXDBFRONTEND_API ListClustersResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_AXDBFRONTEND_API ListClustersResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
