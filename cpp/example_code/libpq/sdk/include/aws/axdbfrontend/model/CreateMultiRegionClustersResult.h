...
namespace Model
{
  ...
  {
  public:
    AWS_AXDBFRONTEND_API CreateMultiRegionClustersResult();
    AWS_AXDBFRONTEND_API CreateMultiRegionClustersResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_AXDBFRONTEND_API CreateMultiRegionClustersResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
