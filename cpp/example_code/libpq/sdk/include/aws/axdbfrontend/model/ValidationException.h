...
#include <aws/axdbfrontend/model/ValidationExceptionReason.h>
#include <aws/core/utils/memory/stl/AWSVector.h>
#include <aws/axdbfrontend/model/ValidationExceptionField.h>
#include <utility>
...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/axdbfrontend-2018-05-10/ValidationException">AWS
   * API Reference</a></p>
   */
  class ValidationException
  {
  public:
    AWS_AXDBFRONTEND_API ValidationException();
    AWS_AXDBFRONTEND_API ValidationException(Aws::Utils::Json::JsonView jsonValue);
    AWS_AXDBFRONTEND_API ValidationException& operator=(Aws::Utils::Json::JsonView jsonValue);
