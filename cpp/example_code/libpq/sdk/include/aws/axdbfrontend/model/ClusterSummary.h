...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/axdbfrontend-2018-05-10/ClusterSummary">AWS
   * API Reference</a></p>
   */
  class ClusterSummary
  {
  public:
    AWS_AXDBFRONTEND_API ClusterSummary();
    AWS_AXDBFRONTEND_API ClusterSummary(Aws::Utils::Json::JsonView jsonValue);
    AWS_AXDBFRONTEND_API ClusterSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
