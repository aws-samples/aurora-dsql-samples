...
namespace Model
{
   ...
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/axdbfrontend-2018-05-10/ConflictException">AWS
   * API Reference</a></p>
   */
  class ConflictException
  {
  public:
    AWS_AXDBFRONTEND_API ConflictException();
    AWS_AXDBFRONTEND_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
    AWS_AXDBFRONTEND_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
