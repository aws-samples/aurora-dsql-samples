...
#include <aws/axdbfrontend/model/ClusterStatus.h>
...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/axdbfrontend-2018-05-10/UpdateClusterOutput">AWS
   * API Reference</a></p>
   */
  class UpdateClusterResult
  {
  public:
    AWS_AXDBFRONTEND_API UpdateClusterResult();
    AWS_AXDBFRONTEND_API UpdateClusterResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_AXDBFRONTEND_API UpdateClusterResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
